...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmailId FROM tblusers WHERE EmailId=:email and telefono=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblusers set Password=:newpassword where EmailId=:email and telefono=:mobile";
...
<div class="modal fade" id="forgotpassword">
  ...
  <div class="form-group">
                  <input type="text" name="mobile" class="form-control" placeholder="Numero di Telefono*" required="">
                </div>
  <div class="form-group">
                  <input type="password" name="newpassword" class="form-control" placeholder="Nuova Password*" required="">
                </div>
  <div class="form-group">
                  <input type="password" name="confirmpassword" class="form-control" placeholder="Conferma Password*" required="">
                </div>
                <div class="form-group">
                  <input type="submit" value="Cambia Password" name="update" class="btn btn-block">
                </div>
              </form>
