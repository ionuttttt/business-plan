			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Noleggi Cancellati</h2>
...
$status=2;
$sql = "SELECT tblusers.nome,tblmarchi.marchio,tblauto.veicolo,tblnoleggi.dataI,tblnoleggi.dataF,tblnoleggi.messaggio,tblnoleggi.IDveicolo as vid,tblnoleggi.Status,tblnoleggi.data,tblnoleggi.id,tblnoleggi.Nnoleggio from tblnoleggi join tblauto on tblauto.id=tblnoleggi.IDveicolo join tblusers on tblusers.EmailId=tblnoleggi.userEmail join tblmarchi on tblauto.marchio=tblmarchi.id where tblnoleggi.Status=:status";
