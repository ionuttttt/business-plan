			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Cambia Password</h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERRORE</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Password Attuale</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Nuova Password</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Conferma Password</label>
												<div class="col-sm-8">
