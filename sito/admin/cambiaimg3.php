...
$sql="update tblauto set Vimage3=:vimage where id=:id";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Immagine 3 del Veicolo </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Dettagli Immagine 3 del Veicolo</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Immagine 3 Attuale</label>
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage3 from tblauto where tblauto.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Carica una Nuova Immagine 3<span style="color:red">*</span></label>
												<div class="col-sm-8">
