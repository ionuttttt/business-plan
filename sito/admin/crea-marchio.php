...
{
$brand=$_POST['brand'];
$sql="INSERT INTO  tblmarchi(marchio) VALUES(:brand)";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Crea Marchio</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Crea Marchio</div>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERRORE</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Invio</button>
												</div>
											</div>
