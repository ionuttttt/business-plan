...
<body>
	...
	<div class="ts-main-content">
		<?php include('inclusioni/leftbar.php');?>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestisci Marchi</h2>

						<div class="panel panel-default">
							<div class="panel-heading">Marchi Disponibili</div>
...
<td><a href="edit-marchio.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="manage-brands.php?del=<?php echo $result->id;?>" onclick="return confirm('Vuoi Cancellare?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
