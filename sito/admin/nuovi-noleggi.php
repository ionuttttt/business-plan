			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Noleggi Nuovi</h2>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php 
$status=0;
$sql = "SELECT tblusers.nome,tblmarchi.marchio,tblauto.veicolo,tblnoleggi.dataI,tblnoleggi.dataF,tblnoleggi.message,tblnoleggi.IDveicolo as vid,tblnoleggi.Status,tblnoleggi.PostingDate,tblnoleggi.id,tblnoleggi.Nnoleggio  
...
<a href="dettagli-noleggi.php?bid=<?php echo htmlentities($result->id);?>"> Vedi</a>
</td>
