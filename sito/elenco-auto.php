...
<?php 
$sql = "SELECT id from tblauto";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Annunci</span></p>
</div>
</div>

<?php $sql = "SELECT tblauto.*,tblmarchi.marchio,tblmarchi.id as bid from tblauto join tblmarchi on tblmarchi.id=tblauto.marchio";
